...
public class PrincipalOauth2UserService extends DefaultOAuth2UserService {
    ...
    @Autowired
    private UserService userService; // 회원조회, 가입 시키기 위해 주입
...
//    private PasswordEncoder passwordEncoder;    // 회원 가입시 pw 인코딩
    ...
    // OAuth2 인증 직후 호출됨
    // provider 로 부터 받은 userRequest 데이터에 대한 후처리 진행
    @Override
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        System.out.println("""
                ...
                userRequest.getClientRegistration().getClientId(),  // id?
        ...
        String username = provider + "_" + providerId;  // ex) "google_xxxxxx"
